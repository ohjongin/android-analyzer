...
/**
 * Abstract class representing analyzer plugin It handles
 * AIDL communication with the Analyzer Core and defines
 * abstract methods for the plugins to implement
 * 
 * @author k.raev
 */
public abstract class AbstractPlugin extends Service {
  ...
  public class PluginConnection extends IAnalyzerPlugin.Stub {
     ...
     * (non-Javadoc)
     * @see
     * org.androidanalyzer.core.IAnalyzerPlugin#getName()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.androidanalyzer.core.IAnalyzerPlugin#startAnalyze
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.androidanalyzer.core.IAnalyzerPlugin#stopAnalyze
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * org.androidanalyzer.core.IAnalyzerPlugin#getTimeout()
     */
    @Override
  ...
  private BroadcastReceiver breceiver = new BroadcastReceiver() {
    ...
    public void onReceive(Context context, Intent intent) {
      boolean conServ = bindService(new Intent(IPluginRegistry.class.getName()), regConnection,
