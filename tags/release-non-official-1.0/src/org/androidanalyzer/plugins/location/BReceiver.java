...
public class BReceiver extends BroadcastReceiver {
  ...
  private static final String TAG = "Analyzer-LocationPlugin-BReceiver";
  ...
  public void onReceive(Context context, Intent intent) {
    context.startService(new Intent(context, LocationPlugin.class));
    Logger.DEBUG(TAG, "Plugin broadcast received for " + LocationPlugin.class);
  }
