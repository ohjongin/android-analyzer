...
public class BReceiver extends BroadcastReceiver {
  ...
  private static final String TAG = "Analyzer-BrowserPlugin-BReceiver";
  ...
  public void onReceive(Context context, Intent intent) {
    context.startService(new Intent(context, BrowserPlugin.class));
    Logger.DEBUG(TAG, "Plugin broadcast received for " + BrowserPlugin.class);
  }
